        ...
        static void Main(string[] args)
        {
            var startupAugs = new InstanceStartupArgumentsEntity
            {
                ...
                LibraryPaths = new List<string>{
                   "libraries/net/minecraftforge/forge/1.7.10-10.13.4.1492-1.7.10/forge-1.7.10-10.13.4.1492-1.7.10.jar",
                    ...
                    "libraries/org/scala-lang/scala-xml_2.11/1.0.2/scala-xml_2.11-1.0.2.jar","libraries/lzma/lzma/0.0.1/lzma-0.0.1.jar",
                ...
                MainJarPath = "LibertyDome-Advanced.jar",
